...
const reddenUserByID = `-- name: ReddenUserByID :exec
UPDATE users
SET is_chirpy_red = true
WHERE id = $1
`

func (q *Queries) ReddenUserByID(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, reddenUserByID, id)
	return err
}
